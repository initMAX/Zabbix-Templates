...
<div align="center">
    <h1>
        Zabbix Ubiquiti UniFi USW Pro Switch Template
    </h1>
    <h4>
        SNMP monitoring of Ubiquiti UniFi USW Pro switches
    </h4>
    <br>
</div>
<br>
...
<!-- *********************************************************************************************************************************** -->
## Description
SNMP v2c monitoring of Ubiquiti UniFi USW Pro switches using standard IF-MIB, ENTITY-MIB and FROGFOOT-RESOURCES-MIB OIDs (bundled in the template).
...
- Fans (LLD) - status and speed
- Temperature sensors (LLD)
...
## Setup
1. Enable SNMP (v2c) on the device and set a read-only community string.
2. In Zabbix, add an **SNMP interface** to the host and set the community (default macro
   `{$SNMP_COMMUNITY}`).
3. Import [`template_ubiquiti_unifi_usw_pro_switch_7.0.yaml`](./7.0/template_ubiquiti_unifi_usw_pro_switch_7.0.yaml) and link the template to the host.
