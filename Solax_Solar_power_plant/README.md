...
<div align="center">
    <h1> 
        Zabbix Solax PowerPlant template
    </h1>
    <h4>
...
<!-- *********************************************************************************************************************************** -->
## Description
Zabbix uses zabbix agent 2 modbus plugin for connecting to Solax device using modbus protocol. You can use any host with zabbix agnet 2.

## Requirements
 - Zabbix 7.0 or higher

## Setup
1\. Create Host for PowerPlant 

2\. Set agent address with some zabbix agent 2

2\. Download and import [template](./7.0/Template_Solax_Solar.yaml)

3\. Set macro {$SOLAX.IP}
