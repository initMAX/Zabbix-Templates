...
---
<div align="center">
    <h1> Zabbix Template - Not Supported Items Template<!-- !!! change version !!! -->
    </h1>
    <h4>
         <!-- !!! change version !!! -->
    </h4>
    <br>
    <!-- <img src="./.readme/screen/template_Zabbix_Cisco_QoS.png" width="1000"> !!! change version !!! -->
</div>
<br>
<br>
...
1\. Download and import template (valid for the version)
  - [6.0](./6.0/Not Supported Items Template.yaml)
...
|----|-----------|-------|
|{$NLD.ITEMS.COUNT}|Trigger limit||
|{$NS.API.KEY}|Zabbix API Key for API Access||
|{$NS.API.URL}|Zabbix URL|('https://<zabbix.dns>/zabbix')|
|{$NS.ITEMS.COUNT}| Trigger limit||
