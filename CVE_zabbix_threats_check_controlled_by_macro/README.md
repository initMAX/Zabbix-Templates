...
<div align="center">
    <h1> <!-- !!! change !!! -->
        CVE Detection and Alerting Template
    </h1>
    <h4>
        Template gets current Zabbix server version and compares it against CVE list on Zabbix Web site <!-- !!! change !!! -->
    </h4>
    <br>
...
<!-- *********************************************************************************************************************************** -->
## Description
This template has single item which gets zabbix server verison from macro {$TEST.VERSION} and compares it with Zabbix CVE page published at https://www.zabbix.com/security_advisories. When actual CVE is found, LLD rule creates item and trigger with published severity.

This template can be used for evaluating CVEs for different versions of Zabbix server.

## Requirements
 - Zabbix 7.0 or higher

## Setup
1\. Download and import [template](./7.0/template_zabbix_CVE_security_server_audit_macro.yaml)<!-- !!! change !!! -->
