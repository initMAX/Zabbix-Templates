...
<div align="center">
    <h1>
        Zabbix FS Switch S3900 Template
    </h1>
    <h4>
        SNMP monitoring of FS S3900 switches
    </h4>
    <br>
</div>
<br>
...
<!-- *********************************************************************************************************************************** -->
## Description
SNMP v2c monitoring of FS S3900 series switches using standard IF-MIB, ENTITY-MIB and vendor OIDs (bundled in the template).
...
2. In Zabbix, add an **SNMP interface** to the host and set the community (default macro
   `{$SNMP_COMMUNITY}`).
3. Import [`template_fs_switch_s3900_7.0.yaml`](./7.0/template_fs_switch_s3900_7.0.yaml) and link the template to the host.
