...
<div align="center">
    <h1>
        Zabbix Ubiquiti UniFi USW Switch Template
    </h1>
    <h4>
        SNMP monitoring of Ubiquiti UniFi USW switches
    </h4>
    <br>
</div>
<br>
...
2. In Zabbix, add an **SNMP interface** to the host and set the community (default macro
   `{$SNMP_COMMUNITY}`).
3. Import [`template_ubiquiti_unifi_usw_switch_7.0.yaml`](./7.0/template_ubiquiti_unifi_usw_switch_7.0.yaml) and link the template to the host.
