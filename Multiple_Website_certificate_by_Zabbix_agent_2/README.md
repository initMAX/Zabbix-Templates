...
1\. Download and import template (valid for the version)
  - Discovery of hosts
    - [7.0](./Discovery_of_hosts/7.0/Multiple_Website_certificate_by_Zabbix_agent_2_host_discovery.yaml)
  - Discovery of items
    - [6.0](./Discovery_of_items/6.0/Multiple_Website_certificate_by_Zabbix_agent_2.yaml)
