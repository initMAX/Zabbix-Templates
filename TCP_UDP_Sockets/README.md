...
<div align="center">
    ...
    <br>
    <img src="./.readme/screen/template_TCP_UDP_sockets.png" width="1000"> <!-- !!! change version !!! -->
</div>
<br>
<br>
...
1\. Download and import template (valid for the version)
  - [6.0](./6.0/template_TCP_UDP_sockets.yaml)
  - [7.0](./7.0/template_TCP_UDP_sockets.yaml)
