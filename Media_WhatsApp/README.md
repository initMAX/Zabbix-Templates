...
<div align="center">
    <h1>
        WhatsApp Notifications for Zabbix
    </h1>
    <h4>
        Integrates Zabbix notifications with WhatsApp Cloud API using webhook and predefined message templates.
    </h4>
    <br>
    <h4>
        Detailed integration guide available on our Wiki:
        <br>
        <a href="https://www.initmax.com/wiki/zabbix-and-whatsapp-notification-integration/">🇬🇧 English version</a> |
        <a href="https://www.initmax.cz/wiki/zabbix-a-whatsapp-integrace-notifikaci/">🇨🇿 Česká verze</a>
    </h4>
</div>
<br>
...
## Description
This template integrates WhatsApp notifications with Zabbix, leveraging WhatsApp Cloud API via webhook and predefined message templates for efficient and structured alerting.

## Requirements
- **Zabbix 7.0 or higher**
- WhatsApp Cloud API (Meta Developer account required)
- Valid access token and phone number ID configured in Zabbix

## Installation

Please follow our detailed guide for step-by-step instructions:

- [🇬🇧 English version](https://www.initmax.com/wiki/zabbix-and-whatsapp-notification-integration/)
- [🇨🇿 Česká verze](https://www.initmax.cz/wiki/zabbix-a-whatsapp-integrace-notifikaci/)

### Macros used
| Macro | Description | Default |
|-------|-------------|---------|
| `access_token` | Your WhatsApp Cloud API access token | `<Access Token>` |
| `phone_number_id` | Your WhatsApp Cloud API phone number ID | `<Phone number ID>` |
