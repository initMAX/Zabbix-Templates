...
- [ClamAV by Zabbix agent](./ClamAV_by_Zabbix_agent)
  - Monitors the freshness and integrity of the ClamAV signature database via a Zabbix Agent UserParameter.
...
- [Windows Update by Zabbix agent](./Windows_Update_by_Zabbix_Agent)
  - Monitors pending Windows updates and reboot requirements via Zabbix Agent - registry flag, update count, and no-data checks.
