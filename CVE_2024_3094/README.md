...
<div align="center">
    <h1> <!-- !!! change version !!! -->
        Tempate-Zabbix6-CVE-2024-3094
    </h1>
    <br>
    <img src="./.readme/screen/CVE-2024-3094.png" width="1000">
</div>
<br>
<br>
...
Template checks host for vulnerability CVE-2024-3094

## Requirements
 - Zabbix 6.0 or higher

## Setup
1\. Download and import [template](./6.0/Template-Zabbix6-CVE-2024-3094.yaml)

2\. Assign on your monitored hosts
