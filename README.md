...
- [CVE_zabbix_threats_check_controlled_by_macro](./CVE_zabbix_threats_check_controlled_by_macro)
  - Evaluates CVEs for different Zabbix server versions using a macro-defined version.

- [CVE_zabbix_threats_check](./CVE_zabbix_threats_check)
  - Checks current Zabbix server version for CVEs and creates alerts.
